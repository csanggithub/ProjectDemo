...
namespace CommonTool.Log4NetHelper
{
    public class ExtLogManager
    {
        ...
        {
            return WrapLogger(log4net.Core.LoggerManager.Exists(domain, name));
        }
        ...
        private static IExtLog WrapLogger(log4net.Core.ILogger logger)
        {
        ...
        private static IExtLog[] WrapLoggers(log4net.Core.ILogger[] loggers)
        {
